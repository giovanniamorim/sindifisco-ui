                ...
                children : [
                    {
                        ...
                        title     : 'Receitas',
                        type      : 'item',
                        url       : '/apps/contabil/lancamentos/receitas',
                    },
                    {
                        id        : 'despesas',
                        title     : 'Despesas',
                        type      : 'item',
                        url       : '/apps/contabil/lancamentos/despesas',
                        exactMatch: true
                    }
                ]
            },
                ...
                children : [
                    {
                        ...
                        type : 'item',
                        url  : '/apps/contabil/tipos-documentos'
                    },
                    {
                        id   : 'modopagamento',
                        title: 'Modo pagamento',
                        type : 'item',
                        url  : '/apps/contabil/modos-pagamentos'
                    },
                    {
                        id   : 'planoconta',
                        title: 'Plano de Conta',
                        type : 'item',
                        url  : '/apps/contabil/planos-contas'
                    },
                    {
                        id   : 'upload',
                        title: 'Upload',
                        type : 'item',
                        url  : '/apps/upload/arquivos'
                    }
                ]
            }
        ]
